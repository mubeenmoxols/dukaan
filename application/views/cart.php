...
<div class="container cnmargin justify-content-md-center">
	<div class="d-flex justify-content-center row cnmargin">
        <div class="col-md-12">
            <div class="p-2">
                <h1><center>Daal</center></h1>
            </div>
            <div class="d-flex flex-row justify-content-between align-items-center p-2 bg-white mt-4 px-3 rounded fa-2x">
                ...
                <div class="d-flex flex-row align-items-center qty">Quantity : 
                   <i id="qty" type="number" name="qty">1</i>
                </div>
                <div>
            ...
            <div class="d-flex flex-row align-items-center mt-4 mb-3 p-2 bg-white rounded-pill total"><i class="col-md-2">Total Bill</i><span class="col-md-9"></span><i class="col-auto">0</i></div>
            <div class="d-flex flex-row align-items-center mt-4 mb-3"><button class="btn btn-dark btn-block rounded-pill col-md-12 total" type="button">Confirm Order</button></div>
        </div>
    </div>
</div>
</div>
...
<footer class="fixed-bottom bgc">	
	<div class="row justify-content-md-center">
		<div class="col-4">
			<a href="<?= site_url('welcome/index') ?>" class="btn">
				<span class="fal fa-home fa-2x"><br>Home</span>
			</a>
		</div>
		<div class="col-4" class="btn">
